...
namespace HealthFitness_System
{
    public partial class Meals : Form
    {
        ...
        private void Meal_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void FoodItems_TextChanged(object sender, EventArgs e)
        {
        ...
        private void BtnExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                saveFileDialog.FileName = "ExportedMealData_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xlsx"; // Append timestamp to ensure uniqueness
        ...
        private void BtnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string insertExerciseQuery = "INSERT INTO meals (UserID, Date, MealName, FoodItems, Calories) VALUES (@UserID, @Date, @MealName, @FoodItems, @Calories)";
                ...
                insertExerciseCommand.Parameters.AddWithValue("@MealName", MealName.Text);
                insertExerciseCommand.Parameters.AddWithValue("@FoodItems", FoodItems.Text);
                insertExerciseCommand.Parameters.AddWithValue("@Calories", Calories.Text);
